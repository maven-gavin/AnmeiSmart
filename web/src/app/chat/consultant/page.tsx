...
function ConsultantChatContent() {
  ...
  const handleCustomerChange = useCallback((customerId: string, conversationId?: string) => {
    const url = conversationId 
      ? `/chat/consultant?customerId=${customerId}&conversationId=${conversationId}`
      : `/chat/consultant?customerId=${customerId}`;
...
export default function ConsultantChatPage() {
  return (
    <AppLayout requiredRole="consultant">
      <ConsultantChatContent />
    </AppLayout>
  );
} 