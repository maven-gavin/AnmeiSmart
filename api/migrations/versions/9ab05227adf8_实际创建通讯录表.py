...
Revision ID: 9ab05227adf8
Revises: ea045294461a
Create Date: 2025-08-20 11:13:51.138479
...
revision: str = '9ab05227adf8'
down_revision: Union[str, None] = 'ea045294461a'
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('status', sa.String(20), default='pending', comment='好友状态：待确认、已接受、已屏蔽、已删除'),
    ...
    op.create_table(
        ...
        sa.Column('category', sa.String(20), default='custom', comment='标签分类'),
    ...
    op.create_table(
        ...
        sa.Column('group_type', sa.String(20), default='personal', comment='分组类型'),
    ...
    op.create_table(
        ...
        sa.Column('friendship_id', sa.String(36), sa.ForeignKey('friendships.id', ondelete='CASCADE'), nullable=False, comment='好友关系ID'),
        sa.Column('role', sa.String(20), default='member', comment='在分组中的角色'),
    ...
    op.create_table(
        ...
        sa.Column('friendship_id', sa.String(36), sa.ForeignKey('friendships.id', ondelete='CASCADE'), nullable=False, comment='好友关系ID'),
        sa.Column('interaction_type', sa.String(50), nullable=False, comment='互动类型'),
