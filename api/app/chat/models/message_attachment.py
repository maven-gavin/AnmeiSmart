...
class MessageAttachment(BaseModel):
    ...
    # 关联关系
    message = relationship("app.chat.models.chat.Message", back_populates="attachments")
    upload_session = relationship("app.common.models.upload.UploadSession", back_populates="message_attachments")
