...
class TenantApplicationService:
    ...
    async def create_tenant_use_case(
        self,
        name: str,
    ...
    async def get_tenant_use_case(self, tenant_id: str) -> Optional[Dict[str, Any]]:
        """获取租户用例"""
        try:
    ...
    async def list_tenants_use_case(self, status: Optional[str] = None) -> List[Dict[str, Any]]:
        """获取租户列表用例"""
        try:
            if status:
    ...
    async def activate_tenant_use_case(self, tenant_id: str) -> bool:
        """激活租户用例"""
        try:
    ...
    async def deactivate_tenant_use_case(self, tenant_id: str) -> bool:
        """停用租户用例"""
        try:
    ...
    async def update_tenant_contact_use_case(
        self,
        tenant_id: str,
        contact_name: Optional[str] = None,
        contact_email: Optional[str] = None,
    ...
    async def delete_tenant_use_case(self, tenant_id: str) -> bool:
        """删除租户用例"""
        try:
    ...
    async def get_tenant_statistics_use_case(self, tenant_id: str) -> Dict[str, Any]:
        """获取租户统计信息用例"""
        try:
