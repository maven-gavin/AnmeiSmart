...
from app.identity_access.controllers.resources import router as resources_router

# Re-export routers
__all__ = ["users_router", "roles_router", "auth_router", "tenants_router", "resources_router"]
