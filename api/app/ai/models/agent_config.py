...
from app.common.deps.uuid_utils import generate_agent_id
...
class AgentConfig(BaseModel):
    ...
    _encrypted_api_key = Column("api_key", Text, nullable=False, comment="LLM API密钥（加密存储）")
    base_url = Column(String(1024), nullable=False, default=lambda: settings.AGENT_DEFAULT_BASE_URL, comment="LLM API Base URL")
