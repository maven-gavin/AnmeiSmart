...
from .interfaces import (
    ...
    AIServiceError, AIProviderUnavailableError, AIRateLimitError
)
...
class AIGateway:
    ...
    async def _execute_with_circuit_breaker(self, 
        ...
        try:
            ...
            elif request.scenario == AIScenario.CONSULTATION_SUMMARY:
                response = await service.summarize_consultation(request)
