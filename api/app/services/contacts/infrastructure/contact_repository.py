...
from app.db.models.contacts import Friendship, ContactTag, ContactGroup, ContactGroupMember, FriendshipTag
from app.services.contacts.domain.interfaces import IContactRepository
