...
from app.services.contacts.domain.value_objects import FriendshipStatus, InteractionRecord
from app.services.contacts.domain.entities.contact_tag import ContactTag
from app.services.contacts.domain.entities.contact_group import ContactGroup
