...
from app.schemas.contacts import ContactTagCreate, CreateContactGroupRequest
from app.services.contacts.domain.interfaces import IContactDomainService, IContactRepository
...
class ContactDomainService(IContactDomainService):
    ...
    async def create_friendship(self, user_id: str, friend_id: str, **kwargs) -> Any:
        ...
        try:
            ...
            from app.db.uuid_utils import friendship_id
    ...
    async def create_contact_group(self, user_id: str, group_data: CreateContactGroupRequest) -> Any:
        ...
        try:
            ...
            # 创建分组对象
            from app.db.models.contacts import ContactGroup
            from app.db.uuid_utils import group_id
