...
from app.services.contacts.domain.interfaces import IContactRepository, IContactDomainService
from app.services.contacts.infrastructure.contact_repository import ContactRepository
from app.services.contacts.domain.contact_domain_service import ContactDomainService
from app.services.contacts.integration.chat_integration_service import ChatIntegrationService
...
def get_chat_integration_service(
    ...
    """获取Chat集成服务实例"""
    # 延迟导入避免循环依赖
    from app.api.deps.chat import get_chat_application_service
