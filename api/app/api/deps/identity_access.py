...
from app.services.identity_access.infrastructure.repositories import (
    UserRepository,
    RoleRepository,
    LoginHistoryRepository
)
from app.services.identity_access.domain import (
    UserDomainService,
    AuthenticationDomainService,
    PermissionDomainService
)
from app.services.identity_access.application import IdentityAccessApplicationService
